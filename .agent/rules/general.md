...
# CORE BEHAVIORS
1.  **Mission-First**: BEFORE starting any task, you MUST read the `.agent\rules\mission.md` file to understand the high-level goal of the agent you are building.
